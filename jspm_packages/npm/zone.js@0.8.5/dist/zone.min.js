...
(function(process) {
  !function(e, t) {
    ...
    function n(e, t) {
      ...
      n.set = function(e) {
        if (this[a] && this.removeEventListener(o, this[a]), "function" == typeof e) {
          var t = function(t) {
            var n;
            return n = e.apply(this, arguments), void 0 == n || n || t.preventDefault(), n;
          };
    ...
    function a(e, t, n) {
      var r = e[I];
      r || (r = e[I] = []), n ? r.unshift(t) : r.push(t);
    }
    function i(e, t, n, r, i, s) {
      ...
      void 0 === n && (n = !0), void 0 === r && (r = !1), void 0 === i && (i = !1), void 0 === s && (s = F);
      var l = O(e),
          h = O(t),
          f = !n && void 0;
      return function(t, n) {
    ...
    function c(e, t, n, r) {
      return void 0 === t && (t = L), void 0 === n && (n = M), void 0 === r && (r = F), !(!e || !e[t]) && (h(e, t, function() {
        ...
        for (r in o)
          "XMLHttpRequest" === t && "responseBlob" === r || !function(e) {
            "function" == typeof o[e] ? Z[t].prototype[e] = function() {
              ...
              set: function(n) {
                "function" == typeof n ? this[H][e] = Zone.current.wrap(n, t + "." + e) : this[H][e] = n;
              },
              get: function() {
                return this[H][e];
              }
    ...
    function g(e, t, n) {
      return n.configurable = !0, n.configurable || (e[A] || R(e, A, {
        writable: !0,
        value: {}
      }), e[A][t] = !0), n;
    }
      ...
      for (var e = function(e) {
        ...
        self.addEventListener(t, function(e) {
          ...
          for (r = o ? o.constructor.name + "." + n : "unknown." + n; o; )
            o[n] && !o[n][G] && (t = Zone.current.wrap(o[n], r), t[G] = o[n], o[n] = t), o = o.parentElement;
        }, !0);
      },
          t = 0; t < W.length; t++)
        e(t);
    ...
    function E(e) {
      ...
      function n(e) {
        ...
        var r = t.target[ne] = function() {
          t.target.readyState === t.target.DONE && !t.aborted && XMLHttpRequest[re] && "scheduled" === e.state && e.invoke();
        };
        t.target.addEventListener("readystatechange", r);
        var o = t.target[ee];
        return o || (t.target[ee] = e), i.apply(t.target, t.args), XMLHttpRequest[re] = !0, e;
      }
      function r() {}
      function o(e) {
        var t = e.data;
    ...
    var O = (function(e) {
      ...
      function n() {
        0 === x && 0 === H.length && (e[I] ? e[I].resolve(0)[L](i) : e[j](i, 0));
      }
      function r(e) {
        n(), H.push(e);
      }
      function o(e) {
        if (!O[t("ignoreConsoleErrorUncaughtError")]) {
          var n = e && e.rejection;
      ...
      function a(e) {
        o(e);
        try {
          var n = O[t("unhandledPromiseRejectionHandler")];
      ...
      function h(e, r, o) {
        ...
        if (e[A] === X) {
          ...
          if (r !== G && o instanceof K && o.hasOwnProperty(A) && o.hasOwnProperty(B) && o[A] !== X)
            f(o), h(e, o[A], o[B]);
            ...
            e[A] = r;
            var c = e[B];
            e[B] = o, r === G && o instanceof Error && (o[t("currentTask")] = O.currentTask);
            ...
            if (0 == c.length && r == G) {
              ...
              try {
                ...
                var d = s;
                d.rejection = o, d.promise = e, d.zone = O.current, d.task = O.currentTask, q.push(d), n();
              }
            }
          }
        }
      ...
      function f(e) {
        if (e[A] === U) {
          try {
            var n = O[t("rejectionHandledHandler")];
      ...
      function d(e) {
        var t = e.prototype,
            n = t.then;
        t[L] = n, e.prototype.then = function(e, t) {
          var r = this,
      ...
      function k() {
        ...
        var r = t.originalStack = t.stack;
        if (k[oe] && r) {
          for (var o = r.split("\n"),
              a = M,
              i = 0; o[i] !== $ && o[i] !== ee && i < o.length; )
            i++;
          for (; i < o.length && a; i++) {
            var s = o[i];
            if (s.trim())
              switch (re[s]) {
                case 0:
                  ...
                  break;
                case 1:
                  a.parent ? (o[i] += " [" + a.parent.zone.name + " => " + a.zone.name + "]", a = a.parent) : a = null;
                  break;
                default:
                  o[i] += " [" + a.zone.name + "]";
              }
          ...
          try {
            t.stack = t.zoneAwareStack = o.join("\n");
          } catch (c) {}
        }
      ...
      var g = {name: "NO ZONE"},
          ...
          O = function() {
            ...
            return t.assertZonePatched = function() {
              ...
              void 0 === t && (t = void 0), void 0 === n && (n = null), void 0 === r && (r = null), M = new P(M, this);
              try {
              ...
              void 0 === t && (t = null), void 0 === n && (n = null), void 0 === r && (r = null), M = new P(M, this);
              try {
                try {
                  return this._zoneDelegate.invoke(this, e, t, n, r);
                } catch (o) {
              ...
              try {
                ...
                e.state !== y && e.state !== w && (e.type == D || e.data && e.data.isPeriodic ? r && e._transitionTo(m, _) : (e.runCount = 0, this._updateTaskCount(e, -1), r && e._transitionTo(y, _, y))), M = M.parent, F = o;
              }
              ...
              try {
                ...
                throw e._transitionTo(w, T, y), this._zoneDelegate.handleError(this, r), r;
              }
              ...
              return this.scheduleTask(new C(S, e, t, n, r, null));
              ...
              return this.scheduleTask(new C(D, e, t, n, r, o));
          ...
          K = function() {
            ...
            return e.toString = function() {
              ...
              var n = new this.constructor(null),
                  r = O.current;
              return this[A] == X ? this[B].push(r, n, e, t) : p(this, r, n, e, t), n;
      ...
      Promise[O.__symbol__("uncaughtPromiseErrors")] = q;
      var $,
          ee,
          te = O.__symbol__("blacklistedStackFrames"),
      ...
      return se.runTask(se.scheduleMacroTask("detect", ce, null, function() {
        return null;
      }, null)), e.Zone = O;
      ...
      return "__zone_symbol__" + e;
        ...
        C = !("nw" in Z) && "undefined" != typeof process && "[object process]" === {}.toString.call(process),
        P = !C && !z && !("undefined" == typeof window || !window.HTMLElement),
        ...
        H = (i(L, M), s(M), O("originalInstance"));
    Zone[O("patchEventTargetMethods")] = c, Zone[O("patchOnProperties")] = r;
    var R = Object[O("defineProperty")] = Object.defineProperty,
        q = Object[O("getOwnPropertyDescriptor")] = Object.getOwnPropertyDescriptor,
        x = Object.create,
        A = O("unconfigurables"),
        ...
        X = "EventTarget",
        W = "copy cut paste abort blur focus canplay canplaythrough change click contextmenu dblclick drag dragend dragenter dragleave dragover dragstart drop durationchange emptied ended input invalid keydown keypress keyup load loadeddata loadedmetadata loadstart message mousedown mouseenter mouseleave mousemove mouseout mouseover mouseup pause play playing progress ratechange reset scroll seeked seeking select show stalled submit suspend timeupdate volumechange waiting mozfullscreenchange mozfullscreenerror mozpointerlockchange mozpointerlockerror error webglcontextrestored webglcontextlost webglcontextcreationerror".split(" "),
        G = O("unbound"),
        U = "set",
        V = "clear",
        K = ["alert", "prompt", "confirm"],
        J = "undefined" != typeof window && window || "undefined" != typeof self && self || global;
    p(J, U, V, "Timeout"), p(J, U, V, "Interval"), p(J, U, V, "Immediate"), p(J, "request", "cancel", "AnimationFrame"), p(J, "mozRequest", "mozCancel", "AnimationFrame"), p(J, "webkitRequest", "webkitCancel", "AnimationFrame");
    for (var Q = 0; Q < K.length; Q++) {
      var Y = K[Q];
      h(J, Y, function(e, t, n) {
        return function(t, r) {
          return Zone.current.run(e, J, r, n);
        };
      });
    }
    T(J);
    var $ = J.XMLHttpRequestEventTarget;
    $ && $.prototype && c($.prototype), _(J), u("MutationObserver"), u("WebKitMutationObserver"), u("FileReader"), d(), S(J), E(J);
    var ee = O("xhrTask"),
        te = O("xhrSync"),
        ne = O("xhrListener"),
        re = O("xhrScheduled");
    J.navigator && J.navigator.geolocation && t(J.navigator.geolocation, ["getCurrentPosition", "watchPosition"]), J.PromiseRejectionEvent && (Zone[O("unhandledPromiseRejectionHandler")] = D("unhandledrejection"), Zone[O("rejectionHandledHandler")] = D("rejectionhandled"));
  });
})(require('process'));
