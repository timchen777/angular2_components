  ...
  !function(global, factory) {
    ...
    var __extends = function(d, b) {
      ...
      d.prototype = null === b ? Object.create(b) : (__.prototype = b.prototype, new __);
        ...
        VERSION = new _angular_core.Version("4.0.0"),
        TextAst = function() {
        ...
        DirectiveResolver = function() {
          ...
          return DirectiveResolver.prototype.isDirective = function(type) {
            ...
            var mergedInputs = this._dedupeBindings(directive.inputs ? directive.inputs.concat(inputs) : inputs),
                ...
                mergedHost = directive.host ? _angular_core.ɵmerge(directive.host, host) : host,
                mergedQueries = directive.queries ? _angular_core.ɵmerge(directive.queries, queries) : queries;
        ...
        ViewBuilder = function() {
          ...
          return Object.defineProperty(ViewBuilder.prototype, "viewName", {
            ...
            for (var currViewExpr = VIEW_VAR,
                currBuilder = this; currBuilder; currBuilder = currBuilder.parent, currViewExpr = currViewExpr.prop("parent")) {
            ...
            if (pipe.pure) {
              ...
              for (var compViewExpr = VIEW_VAR,
                ...
                compBuilder = compBuilder.parent, compViewExpr = compViewExpr.prop("parent");
      ...
      return __extends(PopulatedScope, _super), PopulatedScope.prototype.resolve = function(name) {
        ...
        StaticSymbolResolver = function() {
          function StaticSymbolResolver(host, staticSymbolCache, summaryResolver, errorRecorder) {
            this.host = host, this.staticSymbolCache = staticSymbolCache, this.summaryResolver = summaryResolver, this.errorRecorder = errorRecorder, this.metadataCache = new Map, this.resolvedSymbols = new Map, this.resolvedFilePaths = new Set, this.importAs = new Map, this.symbolResourcePaths = new Map;
          }
